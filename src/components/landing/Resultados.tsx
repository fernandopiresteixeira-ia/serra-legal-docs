...
function StatItem({ stat, start }: { stat: Stat; start: boolean }) {
  ...
  return (
    <div className="flex flex-col items-center text-center px-2 sm:px-4 lg:px-6 py-1">
      <div className="font-display font-bold text-[#F5A623] text-3xl sm:text-4xl lg:text-[44px] leading-none tracking-tight whitespace-nowrap">
        {stat.prefix}{value}{stat.suffix}
      </div>
      <p className="mt-2 lg:mt-3 text-[#1A1A2E] text-[9px] sm:text-[10px] lg:text-xs font-bold uppercase tracking-widest leading-relaxed">
        {stat.label}
      </p>
    </div>
  );
